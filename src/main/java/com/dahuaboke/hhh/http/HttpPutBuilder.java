 ...
 */
public abstract class HttpPutBuilder extends AbstractHttpBuilder {
    ...
    protected Request buildHttp(SocketContext socketContext) {
        ...
        return buildPutRequest(url, headers, body, contentType);
    }

    protected abstract Request buildPutRequest(String url, Map<String, String> headers, String body, String contentType);
}

 ...
 */
public abstract class HttpPutBuilder implements HttpBuilder {
    ...
    public Request build(SocketContext socketContext) {
        ...
        return buildPutRequest(url, headers, param, contentType);
    }

    protected abstract Request buildPutRequest(String url, Map<String, String> headers, String param, String contentType);
}
